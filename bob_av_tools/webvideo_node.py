...
class WebRenderer(Node):
    def __init__(self):
        ...
        if self.pub_topic and HAS_CV_BRIDGE:
            ...
            self.get_logger().warn("CvBridge not found. Disabling Image publisher.")
    ...
    def capture_frame(self):
        ...
        if self.image_pub:
            ...
            try:
                # Use "bgra8" for image.Format_ARGB32 (which is actually BGRA in memory on little-endian)
        ...
        if self.fifo_fd:
            ...
            try:
                ...
                if e.errno == 32: # Broken pipe
                    self.get_logger().warn("Reader disconnected. Closing FIFO.")
